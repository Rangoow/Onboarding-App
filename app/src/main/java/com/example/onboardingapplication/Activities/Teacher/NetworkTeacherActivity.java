...
public class NetworkTeacherActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        NameList = getResources().getStringArray(R.array.network_teacher_name_list);
        desList = getResources().getStringArray(R.array.network_teacher_des_list);
        linkList = getResources().getStringArray(R.array.network_teacher_link_list);

        NetworkAdapter networkTeacherAdapter = new NetworkAdapter(this,NameList,linkList,desList,images);
        recyclerView.setAdapter(networkTeacherAdapter);

...
public class TeacherNetWorkActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        initdate();
        expandableListView_one.setAdapter(new ExpandableListViewaAdapter(TeacherNetWorkActivity.this));

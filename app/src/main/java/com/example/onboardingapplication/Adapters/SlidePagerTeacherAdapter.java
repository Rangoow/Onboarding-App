...
import com.example.onboardingapplication.Activities.Teacher.TeacherNetWorkActivity;
...
public class SlidePagerTeacherAdapter extends PagerAdapter {
    ...
    public SlidePagerTeacherAdapter(Context context, List<TopicItem> listScreen) {
            ...
            public void onClick(View v) {
                switch (position){
                    ...
                    case 2:
                        break;
                    case 3:
                        context.startActivity(new Intent(context, TeacherNetWorkActivity.class));
                        break;
                    case 4:
                        break;
                    case 5:

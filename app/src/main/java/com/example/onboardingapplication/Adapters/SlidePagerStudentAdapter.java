...
import com.example.onboardingapplication.Activities.Student.StudentNetWorkActivity;
            ...
            public void onClick(View v) {
                switch (position){
                    ...
                    case 2:
                        break;
                    case 3:
                        context.startActivity(new Intent(context, StudentNetWorkActivity.class));
                        break;
                    case 4:
                        break;
                    case 5:
